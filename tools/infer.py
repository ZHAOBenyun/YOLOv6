...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default='/media/kemove/2T/YOLOv6_3.0/backbone_RELU/train_b8/exp_l/weights/best_ckpt.pt', help='model path(s) for inference.')
    parser.add_argument('--source', type=str, default='/media/kemove/2T/goodman_test/add5', help='the source path, e.g. image-file/dir.')
    ...
    parser.add_argument('--yaml', type=str, default='/home/kemove/Documents/YOLO_series/YOLOv6/data/dataset_defect.yaml', help='data yaml file.')
    ...
    parser.add_argument('--project', default='/home/kemove/Documents/YOLO_series/YOLOv6/revision/icra', help='save inference results to project/name.')
    parser.add_argument('--name', default='add5', help='save inference results to project/name.')
